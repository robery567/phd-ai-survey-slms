...
nb12_cells = [
    md(
        ...
        "\n",
        "**Runtime:** ~18-24 GPU-hours on A100 (50 behaviors × 3 models × ~7-10 min/run at 250 steps × 512 search-width). ",
        "Slower than the canonical GCG estimate because nanoGCG's `use_prefix_cache=True` shortcut hits a `DynamicCache` ",
        "incompatibility on transformers >=4.43, so we run with `use_prefix_cache=False` (~2x slowdown but correct).\n",
    ...
    code(
        ...
        "    use_prefix_cache=False,   # nanoGCG v0.3.0 + transformers >=4.43 hits\n",
        "                              # 'DynamicCache object is not subscriptable' here.\n",
        ")\n",
    ...
    code(
        ...
        "        seed=REPRO['seed'],\n",
        "        verbosity='WARNING',\n",
        "        use_prefix_cache=False,  # see smoke-test cell above for rationale\n",
        "    )\n",
        "\n",
        ...
        "            raise RuntimeError(\n",
        "                f'Three consecutive GCG failures on {model_id}. '\n",
